...
title, author and range (the check script fails on a stale cache). The notes are
the editor's text (drafted with the model, revised by him on 2026-09-25). Do not
add paths or rewrite notes unasked.
